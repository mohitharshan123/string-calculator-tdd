...
class Calculator:
    ...
    def _get_numbers_array(self):
        ...
        all_numbers = [int(n) for n in numbers_array if n]
        cubed_numbers_for_more_than_three_occurances = self._check_occurances(
            all_numbers
        )

        return cubed_numbers_for_more_than_three_occurances
